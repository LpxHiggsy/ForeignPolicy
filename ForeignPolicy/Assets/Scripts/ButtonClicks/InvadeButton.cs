...
public class InvadeButton : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        if (Player.GetComponent<PlayerSingleton>().GetBudget() > 75000000)
        {
            ...
            Player.GetComponent<PlayerSingleton>().DecreaseBudget(75000000);
